...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <form class="form-horizontal" action="<@spring.url '/courses/${course.id}/delete'/>" method="post">
        <fieldset>
			...
			<div class="control-group">
			    ...
			    <div id="ownerField" class="controls text">${course.category.category}</div>
			</div>
		    <div class="form-actions">
				<button id="subscribeButton" class="btn btn-success" type="submit">Delete</button>
