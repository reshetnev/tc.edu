  ...
  <body>
    <div class="container">
      ...
      <div class="courses-top-control">
        <a class="btn" href="${request.contextPath}/mycourses">My Courses</a>
		<#if role=="Lector">
			<a id="createCourseButton" class="btn btn-primary" href="${request.contextPath}/courses/create">Create</a>
		</#if>
      <@spring.bind "searchForm.category" />		
        <div class="search-box">
          <form class="form-search" action="<@spring.url '/courses'/>" method="post">
            <div class="controls">
      ...
      <table class="table table-striped table-bordered">
        ...
        <tbody>
			<#list courses as course>
				...
				<#if course.state.badge=="New" || course.state.badge=="Open" || course.state.badge=="Ready" || course.state.badge=="In Progress" || course.state.badge=="Finished" >
					<tr>
						<td>${course.id}</td>
						<td>
						...
						<td>
						<#if course.detail.lecturer==email && course.state.badge=="Ready">
							<a class="btn btn-mini" href="${request.contextPath}/courses/${course.id}/start">Start</a>
						</#if>
						<#if course.detail.lecturer==email && course.state.badge=="In Progress">
							<a class="btn btn-mini" href="${request.contextPath}/courses/${course.id}/finish">Finish</a>
						</#if>
						<#if course.detail.lecturer==email && course.state.badge=="Finished">
				...
				<#else>
					...
					<#elseif course.state.badge=="Proposal" || course.state.badge=="Rejected">
						<#if role=="Knowledge Manager">
							<tr>
								...
								<td>
									<#if course.voteKM==1>
										<a class="btn btn-mini" href="${request.contextPath}/courses/${course.id}/approve">Approve</a>
									</#if>
								</td>
							</tr>							
						</#if>
    ...
    <script type="text/javascript" src="<@spring.url '/resources/script/jquery-1.8.1.min.js'/>"></script>
    <script type="text/javascript" src="<@spring.url '/resources/script/bootstrap-2.2.2.min.js'/>"></script>
  </body>
</html>
